	...
	$("#formulario1").validate({
		...
		messages: {
			...
			rut: {
				...
				minlength:'Ingrese un rut valido 1',
				maxlength:'Ingrese un rut valido 2',
			},
			usuario: {
				required: 'Ingrese rut',
				minlenght:'Ingrese almenos 6 digitos',				
			},
			fechanacimiento:{
			...
			numerocel: {
				...
				minlength:'Ingrese numero mayor a 6 mas el digito de area',
				maxlength:'ingrese un numero como maximo de 9 digitos'					
			},
			regiones:{
